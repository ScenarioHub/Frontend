...
export interface ScenarioItem extends ScenarioBase {
  // 시나리오 공유 게시물 화면, 각 아이템
  description: string;
}

export interface ScenarioDetail extends Omit<ScenarioItem, "uploader"> {
  // 시나리오 상세보기 화면
  code: string;
  file: FileInfo;
  isOwner: boolean;
...
// upload 에서 쓰는 것들
export interface ScenarioUploadForm {
  // 시나리오 업로드시 사용 자료구조
